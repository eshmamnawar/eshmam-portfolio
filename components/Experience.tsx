...
const experiences = [
  ...
  },
  {
    ...
    period: "Current",
    description: [
      "Pursuing Bachelor's degree in Software Development",
      "Focusing on modern web technologies, AI, and software architecture",
      "Building projects and contributing to the developer community",
    ],
    type: "Education",
  },
];
